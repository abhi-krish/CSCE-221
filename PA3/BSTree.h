...
public:
  ...
  void update_search_time_helper(Node* ptr, int val);
  void inorder_helper(std::ostream& out, Node* ptr);
  void print_lbl_helper(std::ostream& out, std::vector<Node*> v);
  void erase(Node *ptr);
  //void copy_helper(const Node* otherptr, Node * ptr);
